...
var urlAnalyzer_1 = __importDefault(require("./urlAnalyzer"));
var Crowller = /** @class */ (function () {
    function Crowller(analyzer, url) {
        this.analyzer = analyzer;
        this.url = url;
        this.filePath = path_1.default.resolve(__dirname, "../../data/url.json");
...
var url = "https://www.hanju.run/play/39257-1-1.html";
var analyzer = urlAnalyzer_1.default.getInstance();
