...
var Crawler = /** @class */ (function () {
    function Crawler() {
        this.url = "https://www.hanju.run/play/39257-1-1.html";
        this.initSpiderProcess();
    }
    Crawler.prototype.getJsonInfo = function (html) {
    ...
    Crawler.prototype.getJsonContent = function (info) {
        var filePath = path_1.default.resolve(__dirname, "../data/url.json");
        var fileContent = {};
